...
This handbook is prepended to every agent's prompt. Edit it to change how the
whole company writes and behaves — changes take effect immediately, no restart.
